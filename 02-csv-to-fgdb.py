...
for m in monthList:
        ...
        for a_csv in glob.glob(csv_dir+"trip_data_2013"+m+"*.csv"):
                ...
                arcpy.GenerateNearTable_analysis(gdb+"/trip_"+tripDay+"_p_xy_prj","W:/GIS/Data/Municipal/USA/New_York/New_York_City/Roadbed/ROADBED.shp",gdb+"/trip_"+tripDay+"_p_road","1000 Feet","LOCATION","ANGLE","CLOSEST","0")
