...
csv_dir = 'V:/data/taxi/tripData2013/day/'
wd      = 'V:/data/taxi/tripData2013/'
...
for m in monthList:
        ...
        for a_csv in glob.glob(csv_dir+"trip_data_2013"+m+"*.csv"):
                ...
                arcpy.GenerateNearTable_analysis(gdb+"/trip_"+tripDay+"_d_xy_prj","W:/GIS/Data/Municipal/USA/New_York/New_York_City/Roadbed_copy/ROADBED.shp",gdb+"/trip_"+tripDay+"_d_road","1000 Feet","LOCATION","ANGLE","CLOSEST","0")
